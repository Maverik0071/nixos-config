...
alias nix-flake-update='cd /etc/nixos/ && sudo nix flake update'
alias nixos-full-upgrade='cd /etc/nixos/ && sudo nix-channel --update && sudo nix flake update && nix-update'
alias search='nix-search'
alias zshrc='sudo lvim .zshrc'
alias bashrc='sudo lvim .bashrc'
alias shell='sudo nix-shell -p'
alias flatpak-s='flatpak search'
alias flatpak-in='flatpak install'
alias flatpak-unin='flatpak uninstall'
alias i3config='sudo lvim .config/i3/config'
alias hyprland-config='sudo vim .config/hypr/hyprland.conf'
alias reboot='systemctl reboot'
alias poweroff='systemctl poweroff'
alias hibernate='systemctl hibernate'
alias cp-config2git='sudo cp /etc/nixos/configuration.nix ~/Documents/github/nixos-config/modules/cybersec-config.nix'

...
command_not_found_handler() {
  local p='/nix/store/zfr33ldwxqa3pjynnx0khcfvjc4ah6ql-command-not-found/bin/command-not-found'
...
. /nix/store/0yjplxizfc29iwpdmqv6x66z6zndfzhb-vte-0.74.1/etc/profile.d/vte.sh


# Extra colors for directory listings.
eval "$(/nix/store/bblyj5b3ii8n6v4ra0nb37cmi3lf8rz9-coreutils-9.3/bin/dircolors -b)"
